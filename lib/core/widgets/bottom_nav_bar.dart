...
import 'package:silent_moon/features/sleep/presentation/pages/sleep_music_screen.dart';
import 'package:silent_moon/features/profile/presentation/pages/user_profile_screen.dart';
    ...
    return SizedBox(
      ...
      child: Container(
        ...
        child: BottomNavigationBar(
          ...
          items: [
            _item(
              asset: AppAssets.vector,
              label: 'Home',
              isActive: selectedIndex == 0,
            ),
            _item(
              asset: AppAssets.vectorDash1,
              label: 'Sleep',
            ...
            _item(
              asset: AppAssets.group1,
              label: 'Music',
              isActive: selectedIndex == 3,
            ),
            _item(
              asset: AppAssets.group2,
              label: 'User',
