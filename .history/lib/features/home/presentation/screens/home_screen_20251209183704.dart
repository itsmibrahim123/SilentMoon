...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildActiveIcon(String assetPath) {
    return Container(
      padding: const EdgeInsets.all(10), // Size of the blob
      decoration: BoxDecoration(
        color: const Color(0xFF8E97FD), // Purple background
        borderRadius: BorderRadius.circular(15), // Rounded corners
      ),
      child: Image.asset(
        assetPath,
        width: 22, // Slightly smaller icon inside the blob to fit well
        height: 22,
        color: Colors.white, // White icon looks best on purple
      ),
    );
  }
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        fontSize: 12,
                        color:
                            textColor.withValues(alpha: 179), // ~0.7 opacity
                      ),
                    ),
