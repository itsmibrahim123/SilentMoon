          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Consumer<HomeProvider>(
                      builder: (context, provider, child) {
                        return IconButton(
                          ...
                          icon: const Icon(Icons.shuffle, color: AppColors.primaryPurple),
                        );
                      },
                    ),
                  ],
                ...
                // --- Daily Thought (Now Dynamic from Provider) ---
                Consumer<HomeProvider>(
                  builder: (context, provider, child) {
                    if (provider.sessions.isEmpty) return const SizedBox();
                    final dailySession = provider.sessions.first;
                    return InkWell(
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => CourseDetailScreen(session: dailySession),
                          ),
                        );
                      },
                      child: Container(
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'Daily Thought: ${dailySession.title}',
                                    style: AppTypography.h2.copyWith(
                                      fontSize: fs(18),
                                  ...
                                  Text(
                                    '${dailySession.subtitle.toUpperCase()} • ${dailySession.duration}',
