...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  // Helper: Creates the icon with the purple blob background
  Widget _buildActiveIcon(String assetPath) {
    return Container(
      ...
      child: Image.asset(assetPath, width: 22, height: 22, color: Colors.white),
    );
  }
        ...
        child: BottomNavigationBar(
          items: <BottomNavigationBarItem>[
            ...
            BottomNavigationBarItem(
              ...
              activeIcon: _buildActiveIcon('assets/images/Vector.png'),
              label: 'Home',
            ),
            ...
            BottomNavigationBarItem(
              ...
              activeIcon: _buildActiveIcon('assets/images/Vector-1.png'),
              label: 'Sleep',
            ),
            ...
            BottomNavigationBarItem(
              ...
              activeIcon: _buildActiveIcon('assets/images/Group.png'),
              label: 'Meditate',
            ),
            ...
            BottomNavigationBarItem(
              ...
              activeIcon: _buildActiveIcon('assets/images/Group-1.png'),
              label: 'Music',
            ),
            ...
            BottomNavigationBarItem(
              ...
              activeIcon: _buildActiveIcon('assets/images/Group-2.png'),
              label: 'Afsar',
            ),
          ],
