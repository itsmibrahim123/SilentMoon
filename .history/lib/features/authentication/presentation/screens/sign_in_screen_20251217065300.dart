...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Future<void> _handleGoogleSignIn() async {
    ...
    // Add this print to see if the button is actually clicking
    ...
    if (!success) {
      // Print the actual error from the provider to your console
      print("Google Sign In Error: ${auth.errorMessage}");
