        ...
        children: [
          ...
          Positioned(
            ...
            child: Image.asset(
              ...
              fit: BoxFit.cover, // Cover the top
              width: MediaQuery.of(context).size.width,
              height: 275, // Keep height as before
            ),
          ),

          // SleepScreenBGstar overlay
          Positioned(
            top: 4.88,
            left: 21.44,
            width: 384.74,
            height: 139.13,
            child: Image.asset(
              'assets/images/sleepScreenBGstar.png',
              fit: BoxFit.contain,
            ),
          ),
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                          image: AssetImage('assets/images/sleepBG.png'),
                          fit: BoxFit.cover,
                        ),
                      ),
                      child: Stack(
      ...
      children: [
        Container(
          ...
          child: Stack(
            children: [
              // Cloud decorations
              Positioned(top: 10, left: 20, child: _buildCloud(30, 20, 0.3)),
              Positioned(top: 15, right: 30, child: _buildCloud(25, 18, 0.25)),
              Positioned(top: 5, left: 50, child: _buildCloud(20, 15, 0.2)),
              Positioned(top: 25, right: 15, child: _buildCloud(22, 16, 0.25)),
              Container(
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(10),
