    ...
    return SizedBox(
      ...
      child: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          _item(asset: AppAssets.vector, label: 'Home'),
          _item(asset: AppAssets.vectorDash1, label: 'Sleep'),
          _item(asset: AppAssets.group, label: 'Meditate'),
          _item(asset: AppAssets.vector 'assets/images/Group-1.png', label: 'Music'),
          _item(asset: AppAssets.vector'assets/images/Group-2.png', label: 'Afsar'),
        ],
      ),
    );
  }
